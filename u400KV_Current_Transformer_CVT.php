...
{  
$query = "UPDATE current_transformer_cvt_400kv SET `sno`='$sno',`equipment_name`='$equipment_name' , `make`='$make', `R`='$r',`Y`='$y',`B`='$b',`ratio_available`='$CT_ratio_available',`ratio_adopted`='$CT_ratio_adopted', `date_of_commisioning`='$doc', `present_status`='$present_status', `purchase_order`='$po1' WHERE `sno`='$sno'"; 
...
{
$deletequery = "DELETE FROM current_transformer_cvt_400kv WHERE `sno`='$sno'"; 
...
<html>
    <head>
        <title>400KV Current Transformer CVT</title>
...
window.onload = function () 
{
    ...
    <body>
       <center> <h2>400KV Current Transformer CVT </h2> </center>
<br><br>
...
<tr align="center">
 ...
 $_SESSION['rand']=$rand;
         ...
         if($des=="")
         { 
             $res=mysql_query("Select * from current_transformer_cvt_400kv");
         }
...
<h2>Enter the details to update with Reference ID</h2>
        ...
        <h2>400KV Current Transformer CVT  </h2>
        <form method="post" action="">
            <label for="400KV Current Transformer CVT">Equipment name</label>
&emsp;&emsp;&emsp;&emsp;
