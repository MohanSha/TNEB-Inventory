...
{
$query = "INSERT INTO breakers_110kv (`sno`, `equipment_name`, `make`, `makers_no`, `capacity`, `date_of_commisioning`, `present_status`, `medium`, `operating_mechanism`, `purchase_order`, `location`) VALUES (NULL,'$equipment_name','$make','$makers_no','$capacity','$doc','$present_status','$medium','$operating_mech','$po1','$loc')"; 
...
<html>
  ...
  <input type="text" name="equipment_name" required>
          ...
          <p><br>
            <label for="doc11">Date of commisioning </label>	&emsp;&emsp;&ensp;
        ...
        Location &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
