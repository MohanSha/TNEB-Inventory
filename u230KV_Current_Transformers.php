...
{  
$query = "UPDATE current_transformers_230kv SET `sno`='$sno',`equipment_name`='$equipment_name' , `make`='$make', `R`='$r',`Y`='$y',`B`='$b',`ratio_available`='$CT_ratio_available',`ratio_adopted`='$CT_ratio_adopted', `date_of_commisioning`='$date_of_commisioning', `present_status`='$present_status', `purchase_order`='$purchase_order' WHERE `sno`='$sno'"; 
...
{
$deletequery = "DELETE FROM current_transformers_230kv WHERE `sno`='$sno'"; 
...
<html>
    <head>
        <title>230kv current transformers </title>
...
window.onload = function () 
{
    ...
    <body>
       <center> <h2>230KV current transformers</h2> </center>
<br><br>
        <strong>    <p id="400_cutct"><h2>230KV current transformers &nbsp;</p> </h2>  </strong>
...
<tr align="center">
 ...
 $_SESSION['rand']=$rand;
         ...
         if($des=="")
         { 
             $res=mysql_query("Select * from current_transformers_230KV");
         }
...
<h2>Enter the details to update with Reference ID</h2>
        ...
        <h2>230KV Current Transformer</h2>
