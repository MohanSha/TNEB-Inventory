...
$query = "INSERT INTO surge_arrestors_230kv (`sno`, `equipment_name`, `make`, `R`, `Y`, `B`, `date_of_commisioning`, `present_status`, `purchase_order`, `location`) VALUES (NULL,'$equipment_name','$make','$r','$y','$b','$doc','$present_status','$po1','$loc')"; 
...
<html>
    ...
    <body>
        <h2><u>230KV Surge Arrestors </u></h2>
