...
$query = "INSERT INTO current_transformer_110KV (`sno`, `equipment_name`, `make`, `R`, `Y`, `B`, `CT_ratio_available`, `CT_ratio_adopted`, `date_of_commisioning`, `present_status`, `purchase_order`, `location`) VALUES (NULL,'$equipment_name','$make','$r','$y','$b','$CT_ratio_available','$CT_ratio_adopted','$doc','$present_status','$po1','$loc')"; 
$data = mysql_query ($query)or die(mysql_error()); 
?>

<html>
    <head>
        <title>110KV Current Transformer</title>
    </head>
    <body>
        <form method="post" action="" onSubmit=window.location='success.php'>
            <h2><u>110KV Current Transformer</u></h2>
          <p>
