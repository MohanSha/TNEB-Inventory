...
{  
$query = "UPDATE potential_transformer_110kv SET `sno`='$sno',`equipment_name`='$equipment_name' , `make`='$make', `r`='$r',`y`='$y',`b`='$b',`CT_ratio_available`='$CT_ratio_available',`CT_ratio_adopted`='$CT_ratio_adopted', `date_of_commisioning`='$date_of_commisioning', `present_status`='$present_status', `purchase_order`='$purchase_order' WHERE `sno`='$sno'"; 
...
{
$deletequery = "DELETE FROM potential_transformer_110kv WHERE `sno`='$sno'"; 
...
<html>
    <head>
        <title>110KV Potential Transformers</title>
...
window.onload = function () 
{
    ...
    <body>
       <center> <h2>110KV Potential Transformers </h2> </center>
<br><br>
        <strong>    <p id="400_cutct"><h2>110KV Potential Transformers Details &nbsp;</p> </h2>  </strong>
...
<tr align="center">
 ...
 $_SESSION['rand']=$rand;
         ...
         if($des=="")
         { 
             $res=mysql_query("Select * from potential_transformer_110KV");
         }
...
<h2>Enter the details to update with Reference ID</h2>
        ...
        <h2>110KV Potential Transformers</h2>
