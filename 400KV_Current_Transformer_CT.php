...
$query = "INSERT INTO current_transformer_ct_400kv (`sno`, `equipment_name`, `make`, `R`, `Y`, `B`, `ratio_available`, `ratio_adopted`, `date_of_commisioning`, `present_status`, `purchase_order`, `location`) VALUES (NULL,'$equipment_name','$make','$r','$y','$b','$CT_ratio_available','$CT_ratio_adopted','$doc','$present_status','$po1','$loc')"; 
...
<html>
    ...
    <body>
</body></html><h2><u>400KV Current Transformer CT </u> </h2>
