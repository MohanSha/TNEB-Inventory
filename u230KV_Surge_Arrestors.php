...
{  
$query = "UPDATE surge_arrestors_230kv SET `sno`='$sno',`equipment_name`='$equipment_name' , `make`='$make', `R`='$r',`Y`='$y',`B`='$b',`date_of_commisioning`='$doc', `present_status`='$present_status', `purchase_order`='$po1' WHERE `sno`='$sno'"; 
...
{
$deletequery = "DELETE FROM surge_arrestors_230kv WHERE `sno`='$sno'"; 
...
<html>
    <head>
        <title>230KV Surge Arrestors</title>
...
window.onload = function () 
{
    ...
    <body>
       <center> <h2>230KV Surge Arrestors </h2> </center>
<br><br>
        <strong>    <p id="400_cutcvt"><h2>230KV Surge Arrestors Details &nbsp;</p> </h2>  </strong>
...
<table border="1">
 ...
 $_SESSION['rand']=$rand;
         ...
         if($des=="")
         { 
             $res=mysql_query("Select * from surge_arrestors_230kv");
         }
