...
{
$query = "UPDATE breakers_230kv SET `sno`='$sno',`equipment_name`='$equipment_name' , `make`='$make', `makers_no`='$makers_no',`capacity`='$capacity',`date_of_commisioning`='$doc', `present_status`='$present_status',`medium`='$medium',
...
{
$deletequery = "DELETE FROM breakers_230kv WHERE `sno`='$sno'"; 
...
<html>
    ...
    <body>
       <center> <h2>230KV Breakers </h2> </center>
<br><br>
        <strong>    <p>230KV Breakers Details &nbsp;</p>   </strong>
<table border="1">
  <tr align="center">
    <th>Ref.No</th>
 ...
 $_SESSION['rand']=$rand;
         ...
         if($des=="")
         { 
             $res=mysql_query("Select * from breakers_230KV");
         }
