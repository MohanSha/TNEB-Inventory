...
{  
$query = "UPDATE surge_arrestors_400kv SET `sno`='$sno',`equipment_name`='$equipment_name' , `make`='$make', `R`='$r',`Y`='$y',`B`='$b',`capacity`='$capacity',`MCOV`='$MCOV',`year_of_MFG`='$year_of_MFG', `date_of_commisioning`='$doc', `present_status`='$present_status', `purchase_order`='$po1' WHERE `sno`='$sno'"; 
...
{
$deletequery = "DELETE FROM surge_arrestors_400kv WHERE `sno`='$sno'"; 
...
window.onload = function () 
{
    ...
    <body>
       <center> <h2>400KV Surge Arrestors </h2> </center>
<br><br>
        <strong>    <p id="400_cutcvt"><h2>400KV Surge Arrestors Details &nbsp;</p> </h2>  </strong>
...
<table border="1">
 ...
 $_SESSION['rand']=$rand;
         ...
         if($des=="")
         { 
             $res=mysql_query("Select * from surge_arrestors_400KV");
         }
