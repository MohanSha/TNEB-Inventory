...
$query = "INSERT INTO potential_transformer_110kv (`sno`, `equipment_name`, `make`, `R`, `Y`, `B`, `CT_ratio_available`, `CT_ratio_adopted`, `date_of_commisioning`, `present_status`, `purchase_order`, `location`) VALUES (NULL,'$equipment_name','$make','$r','$y','$b','$CT_ratio_available','$CT_ratio_adopted','$doc','$present_status','$po1','$loc')"; 
$data = mysql_query ($query)or die(mysql_error()); 
?>
<html>
    <head>
        <title>110KV Potential Transformer</title>
    ...
    <body>
        <h2><u>110KV Potential Transformer</u></h2>
